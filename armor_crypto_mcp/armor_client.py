...
class CandleStickRequest(BaseModel):
    ...
    market_cap: bool = Field(default=False, description="Whether to return the market cap of the token")
    time_from: str = Field(default=None, description="The time from which to start the candle sticks in ISO 8601 format. Change start time to keep the number of candles returned to a minimum necessary for analysis.")
    time_to: str = Field(default=None, description="The time to which to end the candle sticks in ISO 8601 format. Avoid using unless doing a historic analysis.")
